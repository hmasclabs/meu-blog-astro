...
import { Home, TrendingUp, Sparkles, Type, Save, Loader2, AlertCircle, Check, RefreshCw, ToggleLeft, Star } from 'lucide-react';
...
function mergeConfig(partial: any): HomeConfig {
    ...
    return {
        hero: {
            title: partial.hero?.title || DEFAULT.hero.title,
            subtitle: partial.hero?.subtitle || DEFAULT.hero.subtitle,
            image: partial.hero?.image || DEFAULT.hero.image,
            buttonText: partial.hero?.buttonText || DEFAULT.hero.buttonText,
            buttonLink: partial.hero?.buttonLink || DEFAULT.hero.buttonLink,
        },
...
type Tab = 'hero' | 'curation' | 'titles' | 'latest' | 'sections';
...
export default function HomeEditor() {
    ...
    const setHero = (key: keyof HomeConfig['hero'], value: string) =>
    ...
    const tabs: { id: Tab; label: string; icon: React.ElementType }[] = [
        { id: 'hero', label: 'Hero (Topo)', icon: Star },
        ...
        <div className="max-w-3xl space-y-6">
            ...
            {tab === 'hero' && (
                <div className="bg-white rounded-2xl border border-slate-200 shadow-sm p-6 space-y-5">
                    <p className="text-sm text-slate-500">Configure a imagem e os textos do banner principal da homepage.</p>
                    
                    <div>
                        <label className="block text-xs font-bold text-slate-500 uppercase tracking-widest mb-1.5">
                            Caminho da Imagem (Foto)
                        </label>
                        <input
                            type="text"
                    ...
                    <div>
                        ...
                        <textarea
                            ...
                            className="w-full px-3 py-2.5 border border-slate-200 rounded-xl text-sm text-slate-700 focus:outline-none focus:ring-2 focus:ring-violet-500/20 focus:border-violet-400 transition-all"
                        />
                        <p className="text-[11px] text-slate-400 mt-1">Dica: use &lt;span style="color: rgb(var(--color-primary));"&gt;Texto&lt;/span&gt; para destacar palavras.</p>
                    </div>
